...
import com.celadonsea.palm.listener.AmqpCallBack;
...
public class TestMessageClient implements MessageClient {
    ...
    public void connect() {
        ...
        callBack = new AmqpCallBack(this, messageClientConfig);
    }
    ...
    public void subscribe(ConsumingProperties consumingProperties, BiConsumer<String, byte[]> messageConsumer) {
        ...
        log.info("Subscribed to exchange {} and to topic {}", consumingProperties.getExchange(), consumingProperties.getTopic());
    }
